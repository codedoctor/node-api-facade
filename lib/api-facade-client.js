  ...
  module.exports = ApiFacadeClient = (function() {
    ...
    */
    ...
    ApiFacadeClient.prototype.mappingsFromSchema = function(schema, options) {
      var filterKey, filterScopes, filterValue, finalFields, key, mappings, resultMappings, v, _ref;
      if (options == null) {
        options = {};
      }
      ...
      filterScopes = ((_ref = schema.filters) != null ? _ref.scopes : void 0) || {};
      if (!(filterScopes && _.keys(filterScopes).length > 0)) {
        return mappings;
      }
      console.log("FILTERSCOPES " + (JSON.stringify(filterScopes)));
      finalFields = {};
      for (filterKey in filterScopes) {
        filterValue = filterScopes[filterKey];
    ...
    */
    ...
    ApiFacadeClient.prototype.mapObjectSync = function(kind, obj, options, resolver) {
      ...
      result = {};
      _ref = this.mappingsFromSchema(schema);
      for (objKey in _ref) {
        target = _ref[objKey];
