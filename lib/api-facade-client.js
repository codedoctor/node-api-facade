  ...
  module.exports = ApiFacadeClient = (function() {
    ...
    */
    ...
    ApiFacadeClient.prototype.mappingsFromSchema = function(schema, options) {
      var filterScopes, filterValue, finalFields, key, mappings, resultMappings, scope, scopeKey, v, _i, _len, _ref;
      if (options == null) {
        options = {};
      }
      if (!schema) {
      ...
      for (scopeKey in filterScopes) {
        filterValue = filterScopes[scopeKey];
        if (_.contains(options.scopes, scopeKey)) {
          _ref = filterValue.fields || {};
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            scope = _ref[_i];
