...
(function() {
  var ApiFacadeClient, Resolver, convertToObject, errors, _,
  ...
  */
  ...
  module.exports = ApiFacadeClient = (function() {
    ...
    ApiFacadeClient.prototype.mapRootCollection = function(kind, pagedResult, options, cb) {
      ...
      result = {
        ...
        items: _.map(pagedResult.items || [], function(x) {
          return _this.mapObjectSync(kind, convertToObject(x), options, resolver);
        })
      };
      result;
    ...
    */
    ...
    ApiFacadeClient.prototype.resolve = function(kind, items, idField, cb) {
      var item, resolver, result, _i, _len,
        _this = this;
      if (items == null) {
        items = [];
      }
      ...
      return resolver.resolve(this.resolvers, result, {}, this, function(err) {
        return cb(null, result);
      });
    };
